...
int compare(const typesystem::ObjectStorage& a, const typesystem::ObjectStorage& b) {
    const auto& a_is_comparable = dynamic_cast<typesystem::HasComparableTrait&>(a.getRawObject())
                               .isComparable();
...
typesystem::ObjectStorage EqualEvaluator::evaluate(runtime::IMemory& memory, const typesystem::ObjectStorage& object) const {
...
typesystem::ObjectStorage CompareEvaluator::evaluate(runtime::IMemory& memory, const typesystem::ObjectStorage& object) const {
    if (object.getType() != typesystem::ObjectType::List)
    {
...
typesystem::ObjectStorage LowerEvaluator::evaluate(runtime::IMemory& memory, const typesystem::ObjectStorage& object) const {
    if (object.getType() != typesystem::ObjectType::List)
    {
...
typesystem::ObjectStorage LowerOrEqualEvaluator::evaluate(runtime::IMemory& memory, const typesystem::ObjectStorage& object) const {
    if (object.getType() != typesystem::ObjectType::List)
    {
...
typesystem::ObjectStorage GreaterOrEqualEvaluator::evaluate(runtime::IMemory& memory, const typesystem::ObjectStorage& object) const {
    if (object.getType() != typesystem::ObjectType::List)
    {
...
typesystem::ObjectStorage GreaterEvaluator::evaluate(runtime::IMemory& memory, const typesystem::ObjectStorage& object) const {
    if (object.getType() != typesystem::ObjectType::List)
    {
