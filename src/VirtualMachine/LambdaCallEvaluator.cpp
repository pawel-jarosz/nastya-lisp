...
namespace nastya::vm {
LambdaCallEvaluator::LambdaCallEvaluator(const typesystem::ObjectStorage& callee,  const std::vector<typesystem::ObjectStorage>& call,
...
typesystem::ObjectStorage LambdaCallEvaluator::preExecute(const typesystem::ListObject& object, runtime::IMachine& vm) const
{
...
typesystem::ObjectStorage LambdaCallEvaluator::evaluate(runtime::IMemory& memory, const typesystem::ObjectStorage& object) const
{
